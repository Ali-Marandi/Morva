...
- M4.54 independently reconstructs the point-in-time M4.52 receipt history behind each M4.53 snapshot and emits deterministic blocker codes plus a verification fingerprint.

...
- M4.61 independently verifies persisted M4.60 results by reconstructing the M4.59 result from the M4.58 snapshot and point-in-time M4.57 source history.

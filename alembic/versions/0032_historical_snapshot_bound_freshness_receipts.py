"""Persist historical snapshot-bound freshness evaluation receipts.

Revision ID: 0032_historical_snapshot_bound_freshness_receipts
Revises: 0031_historical_receipt_snapshot_bindings
"""
...
revision = "0032_historical_snapshot_bound_freshness_receipts"
down_revision = "0031_historical_receipt_snapshot_bindings"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        "historical_snapshot_bound_policy_readiness_freshness_receipts",
        ...
        sa.UniqueConstraint(
            "binding_fingerprint",
            name="uq_historical_snapshot_freshness_receipt_binding_fp",
        ),
    )
    op.create_index(
        "ix_historical_snapshot_freshness_receipt_candidate_sha",
        "historical_snapshot_bound_policy_readiness_freshness_receipts",
        ["candidate_sha"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_historical_snapshot_freshness_receipt_registry_fp",
        "historical_snapshot_bound_policy_readiness_freshness_receipts",
        ["registry_fingerprint"],
    )
    op.create_index(
        "ix_historical_snapshot_freshness_receipt_policy_fp",
        "historical_snapshot_bound_policy_readiness_freshness_receipts",
        ["policy_fingerprint"],
    )
    op.create_index(
        "ix_historical_snapshot_freshness_receipt_state",
        "historical_snapshot_bound_policy_readiness_freshness_receipts",
        ["state"],
    )
    op.create_index(
        "ix_historical_snapshot_freshness_receipt_recorded_by",
        "historical_snapshot_bound_policy_readiness_freshness_receipts",
        ["recorded_by"],
    )
...
def downgrade() -> None:
    op.drop_table("historical_snapshot_bound_policy_readiness_freshness_receipts")

...
Each authoritative case must identify the component and rule-pack version, provide a stable input fingerprint, state the approved treatment and classification flags, and carry a stable expected-output fingerprint.

...
The automated M3.17/M3.18 gate covers registration idempotency, tamper detection, approval SoD, mandatory rejection reason, immutable final decision, policy approval status, policy coverage, exact role enforcement, policy fingerprint integrity and effective-state filtering.

...
2. Deliver M4.1 authoritative evidence intake, M4.2 evidence closure assessment, M4.3 population-scoped treatment evidence, M4.4 master-data evidence binding, M4.5 Rule Pack evidence binding, M4.6 adapter-contract evidence binding, M4.7 payroll-sample evidence binding, M4.8 reconciliation evidence binding and M4.9 disaster-recovery evidence binding as the first evidence-closure implementation tranches; real authoritative artifacts remain external to the codebase and must be independently supplied and approved.

...
- M3.74 independent readiness-handoff verifier with isolated source-root/canonical-role validation
- M3.75 official adapter evidence contract for the canonical adapter set
- M3.76 independent adapter-evidence verifier
- M3.77 adapter activation gate with fail-closed evidence binding
...
- M3.87 CI workflow integrity gate covering workflow structure, scoped main pushes, write permissions and mutation commands
- M3.88 independent integration-execution readiness verifier
- M3.89 readiness-verifier receipt-contract hardening and underlying-evidence tamper regression coverage

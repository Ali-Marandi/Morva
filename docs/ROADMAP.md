...
2. Deliver M4.1 authoritative evidence intake as the first evidence-closure implementation tranche; real authoritative artifacts remain external to the codebase and must be independently supplied and approved.

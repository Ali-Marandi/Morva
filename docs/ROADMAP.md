...
2. Deliver M4.1 authoritative evidence intake, M4.2 evidence closure assessment, M4.3 population-scoped treatment evidence and M4.4 master-data evidence binding as the first evidence-closure implementation tranches; real authoritative artifacts remain external to the codebase and must be independently supplied and approved.

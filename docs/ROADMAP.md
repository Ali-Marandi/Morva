...
1. Keep exact `main` head green across compilation, Ruff, PostgreSQL migrations, pytest, pip-audit and web build; M4.16 evidence lifecycle API is the current main baseline and M4.17 role bindings is the active next tranche.

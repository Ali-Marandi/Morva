...
7. Submission and decision events are auditable.

## Evidence

Approval evidence must retain the order identity, submitting actor, deciding actor, decision, decision time, and any rejection reason. The system remains fail-closed when required provenance is missing.

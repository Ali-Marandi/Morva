...
def _inputs(session):
    ...
    return receipt, m458_snapshot, source_records


def test_m4_61_independently_verifies_m4_60_result():
    engine, session = _session_m4_60()
    try:
        receipt, snapshot, source_records = _inputs(session)
...
def test_m4_61_openapi_route_is_registered():
    ...
    verify_path = (
        ...
        "policy-registry-snapshot-bound/receipt-lineage/independent-verification-history-integrity/"

...
def verify_historical_freshness_chain(
    *,
    ...
    pairs = (
        ...
        ("LINEAGE_RECEIPT_FINGERPRINT_MISMATCH", lineage.freshness_receipt_fingerprint, freshness.fingerprint),
        ("LINEAGE_BINDING_FINGERPRINT_MISMATCH", lineage.historical_binding_fingerprint, historical_binding.fingerprint),
        ("LINEAGE_SNAPSHOT_FINGERPRINT_MISMATCH", lineage.snapshot_fingerprint, snapshot.fingerprint),
        ("FRESHNESS_SNAPSHOT_FINGERPRINT_MISMATCH", freshness.snapshot_fingerprint, snapshot.fingerprint),
        ("BINDING_SNAPSHOT_FINGERPRINT_MISMATCH", historical_binding.snapshot_fingerprint, snapshot.fingerprint),
        ...
        ("BINDING_POLICY_VERSION_MISMATCH", historical_binding.policy_version, policy.policy_version),
        ("LINEAGE_POLICY_FINGERPRINT_MISMATCH", lineage.policy_fingerprint, policy.fingerprint),
        ("BINDING_POLICY_FINGERPRINT_MISMATCH", historical_binding.policy_fingerprint, policy.fingerprint),
        ("LINEAGE_REGISTRY_VERSION_MISMATCH", lineage.registry_integrity_version, snapshot.integrity_version),
        ("FRESHNESS_REGISTRY_VERSION_MISMATCH", freshness.registry_integrity_version, snapshot.integrity_version),
        ("BINDING_REGISTRY_VERSION_MISMATCH", historical_binding.registry_integrity_version, snapshot.integrity_version),
        ("LINEAGE_REGISTRY_COUNT_MISMATCH", lineage.registry_policy_count, snapshot.policy_count),
        ("FRESHNESS_REGISTRY_COUNT_MISMATCH", freshness.registry_policy_count, snapshot.policy_count),
        ("BINDING_REGISTRY_COUNT_MISMATCH", historical_binding.registry_policy_count, snapshot.policy_count),
        ("LINEAGE_REGISTRY_FINGERPRINT_MISMATCH", lineage.registry_fingerprint, snapshot.registry_fingerprint),
        ("FRESHNESS_REGISTRY_FINGERPRINT_MISMATCH", freshness.registry_fingerprint, snapshot.registry_fingerprint),
        ("BINDING_REGISTRY_FINGERPRINT_MISMATCH", historical_binding.registry_fingerprint, snapshot.registry_fingerprint),
    )
